...
slug: goals-for-2018
featured: false
og_title: Goals for 2018 – Johnathan.org
og_description: It’s easy to look back on the last year and realize all the things
  that never got done… all the habits that were never broken… all the weight that
  was never los
meta_title: Goals for 2018 – Johnathan.org
