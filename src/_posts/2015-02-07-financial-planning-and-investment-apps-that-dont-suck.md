...
{% cloudinary_img "Alt text goes here", "5up_appstore_screenshots", "large" %}
...
{% cloudinary_img "Alt text goes here", "5up_betterment_screenshots", "large" %}
...
{% cloudinary_img "Alt text goes here", "5up_robinhood_screenshots", "large" %}
