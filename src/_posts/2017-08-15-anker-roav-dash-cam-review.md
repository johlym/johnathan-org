...
{% cloudinary_img "The open Roav box", "dash_cam_product_shot_open_box.jpg", "large" %}

Cutting through the shrink-wrap plastic and lifting the lid, I was immediately greeted with the star of the show.

{% cloudinary_img "Under the tray", "dash_cam_under_the_cam_tray.jpg", "large" %}
...
{% cloudinary_img "Box contents", "dash_cam_items_in_box.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_set_time_date.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_on_with_vehicle_power.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_power_cable_routing.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_video_screenshot_1080p_30fps.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_app_camera_settings.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_app_video_list.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_app_downloading_short_clip.jpg", "large" %}
...
{% cloudinary_img "", "dash_cam_app_downloading_long_clip.jpg", "large" %}
