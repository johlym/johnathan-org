...
{% cloudinary_img "The open Roav box", "dash_cam_product_shot_open_box", "large" %}

Cutting through the shrink-wrap plastic and lifting the lid, I was immediately greeted with the star of the show.

{% cloudinary_img "Under the tray", "dash_cam_under_the_cam_tray", "large" %}
...
{% cloudinary_img "Box contents", "dash_cam_items_in_box", "large" %}
...
{% cloudinary_img "", "dash_cam_set_time_date", "large" %}
...
{% cloudinary_img "", "dash_cam_on_with_vehicle_power", "large" %}
...
{% cloudinary_img "", "dash_cam_power_cable_routing", "large" %}
...
{% cloudinary_img "", "dash_cam_video_screenshot_1080p_30fps", "large" %}
...
{% cloudinary_img "", "dash_cam_app_camera_settings", "large" %}
...
{% cloudinary_img "", "dash_cam_app_video_list", "large" %}
...
{% cloudinary_img "", "dash_cam_app_downloading_short_clip", "large" %}
...
{% cloudinary_img "", "dash_cam_app_downloading_long_clip", "large" %}
