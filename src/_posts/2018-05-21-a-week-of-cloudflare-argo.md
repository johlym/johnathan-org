...
featured: false
og_title: A Week of Cloudflare Argo – Johnathan.org
og_description: I recently made a pretty heavy shift over to Cloudflare . The majority
  of assets and HTML on this site load from Cloudflare’s servers now, instead of my
  own. Th
meta_title: A Week of Cloudflare Argo – Johnathan.org
