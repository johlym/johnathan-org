...
featured: false
og_title: 'Fake SSL: Another Reason to Own a Mac – Johnathan.org'
og_description: I’m almost positive I’ll receive flack for this from people who think
  I’m talking out my @$$, and that’s fine. Recently, it has come to light that certain
  model
meta_title: 'Fake SSL: Another Reason to Own a Mac – Johnathan.org'
