...
featured: false
og_title: Anker Magnetic Car Mount – Johnathan.org
og_description: There is a newer version of this product available here  that uses
  the air vent, instead. The reviewed version has been discontinued. There’s one problem
  I have
meta_title: Anker Magnetic Car Mount – Johnathan.org
