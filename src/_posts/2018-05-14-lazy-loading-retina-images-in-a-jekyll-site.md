...
featured: false
og_title: Lazy-loading Retina Images in a Jekyll Site – Johnathan.org
og_description: Something I’ve wanted to touch on ever since a couple posts ago was
  lazy loading images. Now that I’m trying to consciously serve 2x images for those
  with such
meta_title: Lazy-loading Retina Images in a Jekyll Site – Johnathan.org
