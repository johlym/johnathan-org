...
<!--kg-card-begin: html--><!--kg-card-begin: html-->- **Ports:&nbsp;** This new configuration starts with saying goodbye to some ports and hello to some others on the back of the metal desk platter of a computer. From left to right, expect to see:<!--kg-card-begin: html--><!--kg-card-begin: html-->
  - Power
  - 1x Ethernet
...
<!--kg-card-end: html--><!--kg-card-end: html-->- **Wireless:** 802.11ac and Bluetooth 5.0.
...
<!--kg-card-begin: html-->- **Camera (rear):** 12-megapixel, f/1.8 camera. Looks like it’s the same as the iPhone XR.<!--kg-card-begin: html-->
  - Records video at up to
    - 4K resolution and 60 frames per second.
    - 1080p 30/60/120 fps.
    - 720p 30/240 fps.
<!--kg-card-end: html-->
<!--kg-card-end: html-->- **Camera (front):** 7-megapixel f/2.2.
