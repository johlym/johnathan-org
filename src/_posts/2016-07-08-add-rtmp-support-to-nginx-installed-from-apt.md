...
featured: false
og_title: Add RTMP Support to Nginx Installed From Apt – Johnathan.org
og_description: In the process of trying to figure out the best streaming solution
  for my cat cam, I had to deviate a bit. I combined my RTMP server for my cat cam
  and Web serv
meta_title: Add RTMP Support to Nginx Installed From Apt – Johnathan.org
