...
featured: false
og_title: My First Legitimate Vagrantfile – Johnathan.org
og_description: I feel like I’ve created this sort of new kind of being. Previously,
  I had rarely used Vagrant or Docker or anything of the sort, so the idea of being
  able to c
meta_title: My First Legitimate Vagrantfile – Johnathan.org
